...
var Beasties = class _Beasties {
      ...
      if (this.options.external !== false) {
        ...
        if (hasCustomEmbed) {
          for (const link2 of externalSheets) {
            yield this.embedLinkedStylesheet(link2, document2);
          }
        } else {
          const sheets = yield Promise.all(
   ...
   */
  fetchStylesheet(link2, document2) {
    return __async(this, null, function* () {
  ...
  embedLinkedStylesheet(link2, document2) {
    return __async(this, null, function* () {
      const sheet = yield this.fetchStylesheet(link2, document2);
      if (sheet) {
        this.embedFetchedStylesheet(sheet, document2);
      }
    });
...
//# sourceMappingURL=chunk-6XAOQS7U.js.map
